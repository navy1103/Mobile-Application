...
public class RegisterFragment extends Fragment {
    ...
    private EditText rUsername, rEmail, rPassword, confirmPass;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        confirmPass = (EditText) v.findViewById((R.id.register_confirm_password));
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(pwd)) {
                    ...
                    rPassword.requestFocus();
                    return;
                } else if(!pwd.equals(confirmPass.getText().toString())){
                    Toast.makeText(v.getContext(), "Password and Confirm Password must be the same password.", Toast.LENGTH_SHORT).show();
                    rPassword.requestFocus();
                    return;
                }
