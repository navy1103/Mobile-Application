...
public class ReminderActivity extends AppCompatActivity implements ReminderListFragment.OnListFragmentInteractionListener, ReminderDetailFragment.UpdateListener{
    ...
    /**
     * The reminder id which use to delete
     */
    ...
    /**
     * Delete the reminder when you click on the button
     * @param item the reminder which you want to delete
     */
    @Override
    ...
    /**
     * Build the URL that use to delete the reminder
     * @return the result
     */
    ...
    private class DeleteTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            loginDialog = new ProgressDialog(ReminderActivity.this);
        ...
        private void getProfile(String result){
            try {
                ...
                if (status.equals("success")) {
                    ...
                    Log.i("Profile", jsonObject.get("first") + " " + jsonObject.get("last") + " " + jsonObject.get("email"));
