package tacoma.uw.edu.tcss450.reminderproject.Modules.Reminder;
...
public class Routine implements Serializable {
    private String mtoDate, mbyTime, mnote;
    //These values must match the json names that we use on the web service.
    public static final String TODATE = "toDate", BYTIME = "byTime", NOTE = "note";

    Routine(String toDate, String byTime, String note){
        this.mtoDate = toDate;
        this.mbyTime = byTime;
        this.mnote = note;
    }
