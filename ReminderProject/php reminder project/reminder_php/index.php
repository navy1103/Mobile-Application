...
if (isset($_POST['tag']) && $_POST['tag'] != '') {
  ...
  $subject = "Change Password Notification";
         $message = "Hello User,nnYour Password is sucessfully changed.nnRegards,nReminder Team.";
          $from = "contact@reminder.com";
          $headers = "From:" . $from;
...
$hash = $db->hashSSHA($randomcode);
  ...
  $subject = "Password Recovery";
         $message = "Hello User,nnYour Password is sucessfully changed. Your new Password is $randomcode . Login with your new Password and change it in the User Panel.nnRegards,Reminder Team.";
          $from = "contact@reminder.com";
          $headers = "From:" . $from;
