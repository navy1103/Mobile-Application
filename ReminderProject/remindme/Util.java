...
public class Util {
	...
	public static final double SEC = 1 * 1000.0;
	public static final double MIN = 60 * SEC;
	public static final double HOUR = 60 * MIN;
	public static final double DAY = 24 * HOUR;
	public static final double WEEK = 7 * DAY;
	...
	public static List csvToList(String csv) {
	 ...
	 public static String fromPersistentTime(String txt) {
		 String[] tokens = txt.split(":");
		 return getActualTime(Integer.parseInt(tokens[0]), Integer.parseInt(tokens[0]));
	 }	 
	...
	public static String fromPersistentDate(String txt, SimpleDateFormat sdf) {
		try {
			return sdf.format(DbHelper.sdf.parse(txt));
		} catch (ParseException e) {}
		return txt;
	}
