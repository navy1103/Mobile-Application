...
error_reporting(E_ALL);
    ...
    try {
            ...
            if($tag === 'add'){
                $sql = "INSERT INTO Reminders (id, setDate, setHour, setMin, note, email, phone, location, username, created_at)";
                $sql .= " VALUES ('$id', '$date', '$hour', '$min', '$note', '$email', '$phone', '$location', '$username',NOW())";
