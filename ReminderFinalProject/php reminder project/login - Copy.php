    ...
    */
    function forget($db){
        ...
        if ($checkEmail == true) {
            ...
            $message = 'Hello '.$result['username'].',nnYour Password is sucessfully changed. Your new Password is  '.$newpass.'. Login with your new Password and change it in the User Profile.nnRegards, Customer Service Team';
